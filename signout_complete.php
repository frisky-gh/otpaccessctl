...
try{
	...
	set_channel_of_log("signout_complete");
	...
	if     ( $sessionkey == "" ){
		...
		$r = pass_is_expired( $sessionkey );
		log_info("pass_is_expired: success.", ["r" => $r, "sessionkey" => $sessionkey]);
	}
...
include("templates/signout_complete.tmpl");
